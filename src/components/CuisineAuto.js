...
import "../styles/CuisineAuto.css";

const CuisineAuto = ({ title }) => {
    ...
    <>
      ...
      >
        <div className="card-image">
          <img src={wikiImage || data.thumbnail?.source || "/placeholder-cuisine.jpg"} alt={title} />
        </div>
